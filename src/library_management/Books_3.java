 ...
 * @author 钟雷
 */
public class Books_3 extends javax.swing.JFrame {
    ...
    public Books_3() {
        ...
        try {
            ...
            String sql = "select * from books where book_name= '" + Delete_Books.book_name + "'";
    ...
    private void initComponents() {
        ...
        delete.setFont(new java.awt.Font("微软雅黑", 1, 18)); // NOI18N
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        int b=JOptionPane.showConfirmDialog(null, "Are you sure?", "tishi", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
       if(b==JOptionPane.YES_NO_OPTION){
           try {
            Connection con = DBClass.getConnection();
            String sql="delete from books where book_name= '"+Delete_Books.book_name+"'";
            Statement statement = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Books_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
