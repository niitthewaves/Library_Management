 ...
 * @author 钟雷
 */
public class Books_4 extends javax.swing.JFrame {
    ...
    public Books_4() {
        ...
        try {
            ...
            String sql = " select book_id from borrow where student_id=? limit 0,1";
            PreparedStatement pdt = con.prepareStatement(sql);
            pdt.setString(1, Welcome_magament.stu_id);
            ...
            if (rs1.next()) {
                ...
                t6.setText(Welcome_magament.stu_name);
                t7.setText(rs1.getString("book_sort"));
                String sql2 = "select * from borrow where book_id = " + book_id;
                Statement statement2 = con.createStatement();
                ResultSet rs2 = statement2.executeQuery(sql2);
                if (rs2.next()) {
                    t8.setText(rs2.getString("expect_return_date"));
                }
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        try {
            i++;
            Connection con = DBClass.getConnection();
            String sql = "select count(*) from borrow where student_id= '" + Welcome_magament.stu_id + "'";
            Statement statement = con.createStatement();
            ResultSet rs = statement.executeQuery(sql);
            String sql2 = "select * from borrow where student_id= '" + Welcome_magament.stu_id + "'" + "limit " + i + ",1";
            Statement statement1 = con.createStatement();
            ResultSet rs1 = statement1.executeQuery(sql2);
            while (rs1.next()) {
                book_id = Integer.parseInt(rs1.getString("book_id"));
            }
            String sql3 = "select * from books where book_id = " + book_id + ";";
            Statement statement2 = con.createStatement();
            ...
            if (i >= Integer.parseInt(rs.getString("count(*)"))) {
                ...
                t1.setText(rs3.getString("book_id"));
                t2.setText(rs3.getString("book_name"));
                t3.setText(rs3.getString("book_author"));
                t4.setText(rs3.getString("book_pub"));
                t5.setText(rs3.getString("book_num"));
                t6.setText(Welcome_magament.stu_name);
                t7.setText(rs3.getString("book_sort"));
                String sql4 = "select * from borrow where book_id = " + book_id;
                Statement statement4 = con.createStatement();
                ResultSet rs4 = statement4.executeQuery(sql2);
                if (rs4.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Books_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
