 ...
 * @author 钟雷
 */
public class Books_5 extends javax.swing.JFrame {
    ...
    public Books_5() {
        ...
        try {
            ...
            String sql = " select * from books where book_author=? limit 1";
            PreparedStatement pdt = con.prepareStatement(sql);
            pdt.setString(1, Welcome_magament.author);
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        try {
            i++;
            Connection con = DBClass.getConnection();
            String sql = "select count(*) from books where book_author= '" + Welcome_magament.author + "'";
            Statement statement = con.createStatement();
            ...
            if (i >= Integer.parseInt(rs.getString("count(*)"))) {
                ...
                String sql2 = "select * from books where  book_author = '" + Welcome_magament.author + "'" + "limit " + i + ",1";
    ...
    private void PreviousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PreviousActionPerformed
        try {
            ...
            Connection con = DBClass.getConnection();
            String sql = " select * from books where book_author=? limit " + i + ",1;";
            PreparedStatement pdt = con.prepareStatement(sql);
            pdt.setString(1, Welcome_magament.author);
            ResultSet rs = pdt.executeQuery();
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Books_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
