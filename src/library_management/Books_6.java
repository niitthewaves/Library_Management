 ...
 * @author 钟雷
 */
public class Books_6 extends javax.swing.JFrame {

    /**
     * Creates new form books_1
     */
    static String book_id, student_id;
    ...
    public Books_6() {
       ...
       try {
            ...
            String sql = "select * from books where book_sort= ? limit 1";
            PreparedStatement pdt = con.prepareStatement(sql);
            pdt.setString(1, Welcome_magament.type);
            ...
            if(rs.next()) {
                ...
                t7.setText(rs.getString("book_sort"));
                String sql4="select * from borrow where book_id = "+ book_id;
                    Statement statement4 = con.createStatement();
                    ResultSet rs4 = statement4.executeQuery(sql4);
                    if(rs4.next()){
                        t8.setText(rs4.getString("expect_return_date"));
                    }
            }
            if ("0".equals(t5.getText())) {
                String sql1 = "select student_id  from borrow where book_id= '" + book_id + "';";
            ...
            String sql2 = "select * from student where stu_id='" + student_id + "';";
            Statement statement = con.createStatement();
            ResultSet rs2 = statement.executeQuery(sql2);
            if (rs2.next()) {
                t6.setText(rs2.getString("stu_name"));
            } else {
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("微软雅黑", 3, 18)); // NOI18N
        jLabel10.setText("Expected return date");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(t3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                                            .addComponent(t2, javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(t1, javax.swing.GroupLayout.Alignment.LEADING))
                                        .addGap(18, 18, 18)
                                        .addComponent(L, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(L, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        try {
            i++;
            Connection con = DBClass.getConnection();
            String sql = "select count(*) from books where book_sort= '" + Welcome_magament.type + "'";
            Statement statement = con.createStatement();
            ...
            if (i >= Integer.parseInt(rs.getString("count(*)"))) {
                ...
                String sql2 = "select * from books where  book_sort = '" + Welcome_magament.type + "'" + "limit " + i + ",1";
                ...
                while (rs1.next()) {
                    ...
                    t7.setText(rs1.getString("book_sort"));
                    String sql4="select * from borrow where book_id = "+ book_id;
                    Statement statement4 = con.createStatement();
                    ResultSet rs4 = statement4.executeQuery(sql4);
                    if(rs4.next()){
                ...
                if ("0".equals(t5.getText())) {
                    ...
                    ResultSet rs2 = statement2.executeQuery(sql1);
                    if (rs2.next()) {
                        System.out.println("121313213");
                        student_id = rs2.getString("student_id");
                    }
                    String sql3 = "select * from student where stu_id='" + student_id + "';";
                    Statement statement3 = con.createStatement();
                    ResultSet rs3 = statement3.executeQuery(sql3);
                    if (rs3.next()) {
                        t6.setText(rs3.getString("stu_name"));
                    } else {
                        System.out.println("//////");
                    }
                }
    ...
    private void PreviousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PreviousActionPerformed
        try {
            ...
            Connection con = DBClass.getConnection();
            String sql = " select * from books where book_sort=? limit " + i + ",1;";
            PreparedStatement pdt = con.prepareStatement(sql);
            pdt.setString(1, Welcome_magament.type);
            ResultSet rs = pdt.executeQuery();
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Books_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
